...
plt.xlabel(r'\textnormal{x}')
plt.ylabel(r'\textnormal{v}')
plt.title(r'\textnormal{Oscilador com atrito e com diferentes valores de "g"}',fontsize=12)

plt.plot(t,x,'-b',linewidth=1,label="x")
plt.plot(t,v,'-g',linewidth=1,label="v")
plt.plot(t,e,'-r',linewidth=1,label="x")
plt.legend(loc="upper right")
plt.grid()
plt.savefig("pf.pdf",dpi=96)
plt.show()
